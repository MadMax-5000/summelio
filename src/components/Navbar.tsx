    ...
    <nav className="sticky top-0 z-50 w-full bg-white shadow-sm backdrop-blur-md">
      <div className="flex justify-between items-center px-4 sm:px-8 lg:px-16 py-3">
        ...
        <div className="hidden md:flex items-center space-x-3">
          {isSignedIn ? (
            <>
              <SignOutButton>
                <Button variant="ghost" className="text-gray-900 hover:text-gray-800 px-4 py-2 font-medium text-sm">
                  Logout
                </Button>
              </SignOutButton>
              <Link href="/dashboard">
                <Button className="bg-gray-900 text-white hover:bg-gray-800 flex items-center gap-1 px-3 py-2 font-medium text-sm">
            ...
            <>
              <SignInButton>
                <Button
                  variant="ghost"
                  className="text-gray-900 hover:text-gray-800 px-4 py-2 font-medium text-sm"
                >
                  Sign In
                </Button>
              </SignInButton>
      ...
      {isMenuOpen && (
        <div className="md:hidden px-4 py-4 bg-white border-t">
          <div className="flex flex-col space-y-4 text-gray-900 font-medium text-base">
            <Link
