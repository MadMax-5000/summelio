      ...
      <div className="mx-auto flex max-w-container flex-col items-center gap-8">
        ...
        <Accordion type="single" collapsible className="w-full max-w-[800px]">
          <AccordionItem value="item-1">
            ...
            <AccordionContent>
              <p className="mb-4 max-w-[640px] text-balance text-zinc-500 dark:text-zinc-400">
          ...
          <AccordionItem value="item-2">
            ...
            <AccordionContent>
              <p className="mb-4 max-w-[600px] text-zinc-500 dark:text-zinc-400">
          ...
          <AccordionItem value="item-3">
            ...
            <AccordionContent>
              <p className="mb-4 max-w-[580px] text-zinc-500 dark:text-zinc-400">
          ...
          <AccordionItem value="item-4">
            ...
            <AccordionContent>
              ...
              <p className="mb-4 max-w-[580px] text-zinc-500 dark:text-zinc-400">
                ...
                <Link href="/pricing" className="text-zinc-950 underline dark:text-zinc-50">
                  the pricing page
                </Link>
                .
              </p>
            ...
            <AccordionContent>
              <p className="mb-4 max-w-[580px] text-zinc-500 dark:text-zinc-400">
                ...
                <Link
                  ...
                  className="text-zinc-950 underline dark:text-zinc-50"
                >
                  Figma community
                </Link>
                .
