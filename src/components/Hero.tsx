        ...
        >
          ...
          <DialogPanel className="fixed inset-y-0 right-0 z-50 w-full overflow-y-auto bg-white px-6 py-6 sm:max-w-sm sm:ring-1 sm:ring-gray-900/10">
            ...
            <div className="mt-6 flow-root">
              <div className="-my-6">
                {/* Removed the login button for mobile view */}
              </div>
            </div>
          </DialogPanel>
        </Dialog>
        ...
        <div className="mx-auto max-w-2xl py-20 sm:py-48 lg:py-10">
          ...
          <div className="text-center">
            <h1 className="text-5xl font-semibold tracking-tight text-balance text-gray-900 sm:text-7xl">
              Convert Any Content into an AI-Powered Chat{" "}
            </h1>
            <p className="mt-8 text-lg font-medium text-pretty text-gray-500 sm:text-xl/8">
              Bring Your Content to Life : Transform Your Documents Into
              Real-Time Conversations with Ease
            </p>
