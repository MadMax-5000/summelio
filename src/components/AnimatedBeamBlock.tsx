...
export const AnimatedBeamBlock = ({ className }: { className?: string }) => {
  ...
  return (
    <div
      className={cn(
        "relative flex h-[750px] w-full items-center justify-center overflow-hidden rounded-lg bg-background p-16 md:shadow-xl",
        className
      )}
      ref={containerRef}
    >
      <div className="absolute top-0 left-0 right-0 text-center z-20 mx-auto max-w-3xl px-4">
        <h2 className="lg:text-5xl mb-10 tracking-[-2.15px] text-gray-700 sm:5xl text-balance font-semibold leading-[110%] text-center">
          Managing research projects has never been so easy
        </h2>{" "}
        <p className="text-lg text-gray-700 text-center">
          Afford offers a fresh take on storing your research materials,
